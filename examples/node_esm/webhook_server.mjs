/**
 * Example webhook server with expressjs and ngrok
 *
 * Installation:
 * 1. Install dependencies: npm install express @ngrok/ngrok
 ...
 * 3. Run the script: node examples/webhook-server-express.mjs
 * 4. Use the public ngrok url in your Scrapfly webhook configuration
 * [optional for the verficication step]
