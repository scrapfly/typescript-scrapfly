/**
 * Example webhook server with expressjs and ngrok (CommonJS)
 *
 * Installation:
 * 1. Install dependencies: npm install express @ngrok/ngrok scrapfly-sdk
 ...
 * 3. Run the script: node examples/node_commonjs/webhook_server.cjs
...
const { createServer, verifySignature } = require('scrapfly-sdk');
